...
int main()
{
    ...
    journal_entry entry, copy_of, blank_entry;                //Start creating entries!
    list my_journal;
    ...
    do
    {
       ...
       //bool result = copy_of.copy_entry(entry);
       //if(result)
       //    cout << "Successful copy!" << endl;
       //else
       //    cout << "Unsuccessful copy!" << endl;
       ...
       cout << "Please enter title of a journal entry you want to retrieve: ";
       cin.get(title, SIZE, '\n');
       cin.ignore(100,'\n');

       //Pass in an empty object to potentially deep copy into
       if(!my_journal.find(title, blank_entry))
