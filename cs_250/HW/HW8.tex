...
\vspace{0cm}\maketitle 
	...
	\subparagraph{Problem 1} 4.1 Graph Definitions (pg. 243-246) \\
        ...
        %3
        \setItemNumber{3}
    \item Is it possible for two \texti{different} (non-isomorphic) graphs to have the same number of vertices and the same number of edges? What if the degrees of the vertices in the two graphs are the same (so both graphs have vertices with degrees 1, 2, 2, 3, and 4, for example)? Draw two such graphs or explain why not.
